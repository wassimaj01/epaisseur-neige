...
const MapLayers = ({ layerVisibility, snowColorScale, minSnowDepth, maxSnowDepth }) => {
  const neige4326Layer = {
    id: 'neige4326-layer',
    type: 'fill-extrusion',  // Change to fill-extrusion for 3D effect
    source: 'neige4326',
    ...
    paint: {
      'fill-extrusion-color': snowColorScale,
      'fill-extrusion-opacity': 0.8,
      'fill-extrusion-height': ['*', ['get', 'snow_depth'], 10],  // Exaggerate height for visibility
